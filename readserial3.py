...
#        timestamp = str(time.time())
        station,rssi,mac = line.split(b",")
        print(station,rssi,mac)
        cursor.execute("INSERT INTO wifi_diy (station, rssi, mac) VALUES(%s, %s, %s)", (station.decode("utf-8"),rssi.decode("utf-8"),mac.decode("utf-8") ))
        conn.commit()
